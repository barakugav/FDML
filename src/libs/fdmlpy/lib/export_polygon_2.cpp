...
FDML::Point& left_vertex(FDML::Polygon& P) {
    return *(P.left_vertex());
}
FDML::Point& right_vertex(FDML::Polygon& P) {
    return *(P.right_vertex());
}
FDML::Point& top_vertex(FDML::Polygon& P) {
    return *(P.top_vertex());
}
FDML::Point& bottom_vertex(FDML::Polygon& P) {
    return *(P.bottom_vertex());
}
...
CopyIterator<FDML::Polygon::Edge_const_iterator>* edges_iterator(FDML::Polygon& P) {
...
void export_polygon_2() {
    ...
    bp::class_<Polygon>("Polygon_2")
        ...
        .def("is_counterclockwise_oriented", &Polygon::is_counterclockwise_oriented)
        ...
        .def("vertices", bp::range<bp::return_internal_reference<>>(&Polygon::vertices_begin, &Polygon::vertices_end))
        .def("edges", &pol2::edges_iterator, Manage_new_object())
        .def<const Point& (Polygon::*)(std::size_t) const>("__getitem__", &Polygon::operator[], Copy_const_reference())
        ...
        .def<const Point& (Polygon::*)(std::size_t) const>("vertex", &Polygon::vertex, Copy_const_reference())
