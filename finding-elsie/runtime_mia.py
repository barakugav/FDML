...
def generate_command_str(first, second, third, delta, radius):
    return 'bin/mia --m1-path=data/manifolds/m3_{}.obj --m2-path=data/manifolds/m3_{}.obj --mout-path=data/manifolds/m3_{}.obj --radius={} --delta={}'.format(first, second, third, radius, delta).split()
