...
void DeltaCube::split(std::vector<DeltaCube>& list) {
  ...
  list.push_back(
      DeltaCube(Point_3(center.x(), bottom_left.y(), bottom_left.z()), Point_3(top_right.x(), center.y(), center.z())));
  list.push_back(
      DeltaCube(Point_3(bottom_left.x(), center.y(), bottom_left.z()), Point_3(center.x(), top_right.y(), center.z())));
  list.push_back(
      DeltaCube(Point_3(center.x(), center.y(), bottom_left.z()), Point_3(top_right.x(), top_right.y(), center.z())));
  list.push_back(
      DeltaCube(Point_3(bottom_left.x(), bottom_left.y(), center.z()), Point_3(center.x(), center.y(), top_right.z())));
  list.push_back(
