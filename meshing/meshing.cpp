...
int main(int argc, char** argv) {
    ...
    if (mo.single_measurement) {
        Surface_mesh sm;
        // single_measurement(sm, arr, pl, mo.d1, Point_3(mo.sphere_x, mo.sphere_y, mo.sphere_z), mo.sphere_r,
        // mo.angle_bound,
        ...
        // start = std::chrono::steady_clock::now();
        // single_measurement_rotate_alpha(m_d2, arr, pl, mo.d2, Point_3(mo.sphere_x, mo.sphere_y, mo.sphere_z),
        // mo.sphere_r,
